...
class Agent:
    ...
    def build_actor_critic(self):
        ...
        model_actor.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=LR, epsilon=1e-05),
        ...
        # 7. Gradient Clip
        model_critic.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=LR, epsilon=1e-05), loss='mse')
